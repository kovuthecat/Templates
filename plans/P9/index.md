...
| [S4](S4.md) | T9 | Publier 0.42.0 | Sonnet | low | — | S1, S2, S3 | `plugin/.claude-plugin/plugin.json` · `CHANGELOG.md` · `plugin/MIGRATION.md` · `plugin/skills/fin-de-tache/references/fin-de-plan.md` · `TASKS.md` | [x] (2026-09-23) | T9 `chore(plugin): 0.42.0 — revue d'usage, brief tenu par les décisions` |
