...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [S1](S1.md) | T1-T3 | (a) Garanties exactes et référence de compatibilité | Sonnet | medium | — | — | `plugin/skills/cadrer/SKILL.md`, `plugin/skills/revue-de-conception/SKILL.md`, `docs/analyses/2026-09-12-conseils-anthropic-contexte-skills-verification.md`, `docs/references/claude-code-capabilities-2026-08.md` | [ ] |
| [S2](S2.md) | T4-T6 | (b) Gabarits sans stack, contraintes avant stack | Sonnet | medium | — | — | `plugin/skills/nouveau-plan/references/squelette-index.md`, `plugin/agents/verificateur-plan.md`, `plugin/skills/nouveau-projet/SKILL.md` | [ ] |
| [S3](S3.md) | T7-T9 | (g) Gates de publication étendues, agnix en rapport | Sonnet | medium | — | — | `tests/tester-renvois.mjs`, `tests/tester-hooks.mjs`, `docs/analyses/2026-09-<jj>-agnix-rapport.md` (nouveau) | [ ] |
